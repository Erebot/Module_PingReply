...
function Erebot_Module_PingReply_autoload($class)
{
    $class = str_replace(array('_', '\\'), '/', $class);
    if (file_exists('phar://' . __FILE__ . '/Erebot_Module_PingReply-0.1.0/php/' . $class . '.php')) {
        include 'phar://' . __FILE__ . '/Erebot_Module_PingReply-0.1.0/php/' . $class . '.php';
    }
}
spl_autoload_register("Erebot_Module_PingReply_autoload");
